sed -i.bu '/oneAsh/ s/1/0/' /Applications/techtime.app/Contents/MacOS/techtime.1s.sh
...
sed -i.bu '/fiveAsh/ s/0/1/' /Applications/techtime.app/Contents/MacOS/techtime.1s.sh
sed -i.bu '/sixAsh/ s/1/0/' /Applications/techtime.app/Contents/MacOS/techtime.1s.sh
sed -i.bu '/factsh/ s/1/0/' /Applications/techtime.app/Contents/MacOS/techtime.1s.sh
