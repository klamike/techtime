...
sed -i.bu '/sixAsh/ s/0/1/' /Applications/techtime.app/Contents/MacOS/techtime.1s.sh
sed -i.bu '/fashsh/ s/1/0/' /Applications/techtime.app/Contents/MacOS/techtime.1s.sh
